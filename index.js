...
let setItemGallery = " "; // Добавляю элементы в html.
...
gallery.insertAdjacentHTML('afterbegin', setItemGallery); // Добавляю слушателей

gallery.addEventListener('click', openImage); // Функция открытия картинки в оригинальном размере
